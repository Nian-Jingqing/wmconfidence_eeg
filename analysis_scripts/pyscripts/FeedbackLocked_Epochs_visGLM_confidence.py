...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul 20 11:37:09 2020
...
for channel in ['Fz', 'FCz', 'Cz']:
    mne.viz.plot_compare_evokeds(
            ...
            show_sensors = False, title = 'confidence regressor: electrode '+channel, truncate_xaxis = False)
...
for channel in ['FCz', 'Cz']:
    ...
    fig.savefig(fname = op.join(figpath, 'feedbackERP_confidenceRegressor_clustertimesFrom_%s_betas.eps'%(channel)), format = 'eps', dpi = 300 )
    fig.savefig(fname = op.join(figpath, 'feedbackERP_confidenceRegressor_clustertimesFrom_%s_betas.pdf'%(channel)), format = 'pdf', dpi = 300 )

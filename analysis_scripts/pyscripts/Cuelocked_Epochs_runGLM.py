...
for i in subs:
    ...
    for laplacian in [True, False]:
        ...
        contrasts.append(glm.design.Contrast([ 1,  1,  1,  1], 'grandmean'))
        contrasts.append(glm.design.Contrast([ 1,  0,  0,  0], 'neutral left'))
        contrasts.append(glm.design.Contrast([ 0,  1,  0,  0], 'cued left'))
        contrasts.append(glm.design.Contrast([ 0,  0,  1,  0], 'neutral right'))
        contrasts.append(glm.design.Contrast([ 0,  0,  0,  1], 'cued right'))
        contrasts.append(glm.design.Contrast([ 1,  0,  1,  0], 'neutral'))
        contrasts.append(glm.design.Contrast([ 0,  1,  0,  1], 'cued'))
        contrasts.append(glm.design.Contrast([-1,  1, -1,  1], 'cued vs neutral'))
        contrasts.append(glm.design.Contrast([-1,  1,  0,  0], 'clvsn'))
        contrasts.append(glm.design.Contrast([ 0,  0, -1,  1], 'crvsn'))
        contrasts.append(glm.design.Contrast([ 0,  1,  0, -1], 'clvsr'))
        contrasts.append(glm.design.Contrast([ 1,  0, -1,  0], 'nlvsr')) #this should only really be useful if looking at behavioural regressor, shouldn't find anything in main effects
